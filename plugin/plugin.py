...
config.OpenWebif.about_benchmarkcpu = ConfigYesNo(default=False)
config.OpenWebif.about_benchmarkram = ConfigYesNo(default=False)
config.OpenWebif.about_benchmarkpython = ConfigYesNo(default=False)
...
class OpenWebifConfig(Screen, ConfigListScreen):
	...
	<screen position="center,center" size="700,340" title="OpenWebif Configuration">
		<widget name="lab1" position="10,30" horizontalAlignment="center" size="680,60" zPosition="1" font="Regular;24" verticalAlignment="top" transparent="1" />
		...
		<widget name="key_red" position="140,290" zPosition="1" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="red" transparent="1" />
		<ePixmap position="420,290" size="140,40" pixmap="buttons/green.png" alphaTest="on" zPosition="1" />
		<widget name="key_green" position="420,290" zPosition="2" size="140,40" font="Regular;20" horizontalAlignment="center" verticalAlignment="center" backgroundColor="green" transparent="1" />
	</screen>"""
	...
	def runSetup(self):
		...
		if config.OpenWebif.enabled.value:
			self.list.append(getConfigListEntry(_("Show CPU benchmark in STB information"), config.OpenWebif.about_benchmarkcpu))
			self.list.append(getConfigListEntry(_("Show RAM benchmark in STB information"), config.OpenWebif.about_benchmarkram))
			self.list.append(getConfigListEntry(_("Show Python benchmark in STB information"), config.OpenWebif.about_benchmarkpython))
